...
const standardizePhoneNumbers = (arr) => {
  // Solution code here...
  return arr.map(phNum=>{
      let first=phNum.substring(phNum.indexOf('(')+1,phNum.indexOf(')'));
      let sec = phNum.substring(phNum.indexOf(' ')+1,phNum.indexOf('-'));
      let final = phNum.substring(phNum.indexOf('-')+1,phNum.length);
